...
public sealed class ExecutionSummaryPluginReportByUrl : ExecutionSummaryPluginReportBase;
public sealed class ExecutionSummaryPluginReportByMessageType : ExecutionSummaryPluginReportBase;
