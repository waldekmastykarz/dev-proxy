...
sealed class OutdatedCommand : Command
{
    ...
    public OutdatedCommand(IProxyConfiguration proxyConfiguration, ILogger<OutdatedCommand> logger) :
    ...
    {
        var releaseInfo = await UpdateNotification.CheckForNewVersionAsync(_proxyConfiguration.NewVersionNotification);
